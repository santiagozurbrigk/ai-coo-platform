...
export const mockInsights: IntelligenceInsight[] = [
  ...
  {
    id: "i2",
    title: "Brecha de follow-up en ventas",
    body: "El 12% de conversaciones activas superan 4h sin respuesta del equipo — impacto en tasa de fantasma.",
    confidence: 0.87,
    department: "Ventas",
...
export const mockRecommendations: IntelligenceRecommendation[] = [
  ...
  },
  {
    id: "rec2",
    priority: "medium",
    title: "Estandarizar guiones de DM",
    action: "Extraer patrones al Contexto de negocio para capacitación del equipo de ventas",
  },
];
...
export const mockBottlenecks: IntelligenceBottleneck[] = [
  ...
  { id: "b2", area: "Cobertura ventas fin de semana", impact: "Brechas de respuesta 24h+", frequency: "Semanal" },
];

export const mockOpportunities: IntelligenceOpportunity[] = [
  {
    id: "op1",
    title: "Subida de tasa de agendamiento",
    potential: "+6–9% optimizando follow-up y guiones del equipo de ventas",
  },
