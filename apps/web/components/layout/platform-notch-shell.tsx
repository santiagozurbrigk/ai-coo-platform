...
/**
 * Shell alternativo de plataforma: notch nav superior en lugar de sidebar.
 * Se activa con NEXT_PUBLIC_NAV_STYLE=notch (ver lib/navigation/nav-style.ts).
 *
 * El sidebar clásico (PlatformShell) queda intacto — este archivo se puede
 * borrar entero para deshacer el experimento.
 */
export function PlatformNotchShell({ children }: { children: ReactNode }) {
