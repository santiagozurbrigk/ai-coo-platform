...
const AREA_FOCUS_BADGE: Record<string, string> = {
  ventas: "bg-blue-500/15 text-blue-700 dark:text-blue-400 border-blue-500/30",
  marketing: "bg-violet-500/15 text-violet-700 dark:text-violet-400 border-violet-500/30",
  operaciones: "bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-500/30",
  delivery: "bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 border-emerald-500/30",
  producto: "bg-pink-500/15 text-pink-700 dark:text-pink-400 border-pink-500/30",
