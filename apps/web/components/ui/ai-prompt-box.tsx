        ...
        >
          <div
            ...
            className={cn(
              ...
              "prompt-input-box rounded-3xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] px-3 pt-3 pb-2 shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all duration-300",
...
export const PromptInputBox = React.forwardRef(
  (props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
    ...
    const input = controlledValue ?? internalInput;
    ...
    React.useEffect(() => {
      if (controlledValue !== undefined) {
        setInternalInput(controlledValue);
      }
    }, [controlledValue]);
