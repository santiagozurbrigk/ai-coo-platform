...
export const modulesWithChildren: Record<SidebarParentKey, SidebarParentModule> =
  {
    ...
    operaciones: {
      ...
      children: [
        ...
        { label: "Reporte semanal", href: paths.platform.executiveReports.weekly },
        { label: "Reporte mensual", href: paths.platform.executiveReports.monthly },
        { label: "Historial reportes", href: paths.platform.executiveReports.history },
