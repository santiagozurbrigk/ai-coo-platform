...
export type ClaudeKeySource = "byok" | "global";
...
export function claudeNoCreditsUserMessage(keySource: ClaudeKeySource): string {
  if (keySource === "byok") {
    return "No se pudo generar el contenido con IA: tu cuenta de Claude no tiene créditos disponibles. Revisá tu configuración en Settings → API key de Claude, o contactá al soporte si el problema persiste.";
  }
