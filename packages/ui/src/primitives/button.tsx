...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-[13px] font-medium select-none transition-all duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "rounded-[10px] border border-white/10 bg-gradient-to-br from-primary to-primary-hover text-white shadow-[0_4px_16px_rgba(124,58,237,0.35)] hover:brightness-110 hover:shadow-[0_6px_20px_rgba(124,58,237,0.45)] active:scale-95 active:bg-violet-700 active:shadow-[0_0_0_4px_rgba(124,58,237,0.25)] active:animate-btn-press",
        destructive:
        ...
        ghost:
          "rounded-[10px] border border-primary/30 bg-transparent text-primary hover:bg-primary/10 active:scale-95 active:bg-white/[0.06] active:animate-btn-press-ghost dark:border-[rgba(124,58,237,0.30)] dark:text-primary-light dark:hover:bg-[rgba(124,58,237,0.08)]",
