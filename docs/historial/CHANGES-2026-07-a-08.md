# Historial de cambios — julio y agosto 2026

Parte archivada de `CHANGES.md` (se partió el 2026-09-23). Las entradas se conservan tal cual se escribieron:
describen el estado **de ese momento** y muchas rutas, tablas o pendientes que nombran ya cambiaron. Para el
estado actual, ver `docs/areas/` y `PENDIENTES.md`.
