---
title: "Bounty"
source: "https://docs.whop.com/api-reference/beta/bounties/bounty"
...
<Columns cols={2}>
  <Column>
    ...
    <ResponseField name="min_total_verified_duration_seconds" type="integer | null" required>
      Total verified footage a submission must accumulate before it can be
      submitted, in seconds. Always a whole number of hours. Present only on
      `data_capture` bounties — it is what `net_reward_amount` pays for, so rate
      displays divide by it. `null` for every other goal type.
    </ResponseField>
  ...
  <Column>
    <div className="api-resource-sticky-example">
      ```json Bounty theme={null}
      {
      	...
      	"capture_spec": null,
      	"min_total_verified_duration_seconds": null,
      	...
      	"hosting_account": {
      		...
      		"title": "Acme Studio",
      		"route": "acme-studio",
      		"logo_url": "https://img.whop.com/acme-studio-logo.png"
      	},
      	"poster": {
      		"id": "user_xxxxxxxxxxxx",
