---
title: "Partners"
source: "https://docs.whop.com/api-reference/beta/partners/partner"
...
<Columns cols={2}>
  <Column>
    ...
    <ResponseField name="blueprint_partner" type="object | null" required>
    ...
    <ResponseField name="my_partner_tier" type="string" required>
      ...
      Available options: `first`, `second`, `blueprint`
    </ResponseField>
    ...
    <ResponseField name="owner" type="object | null" required>
      ...
      <Accordion title="Properties" defaultOpen={true}>
        ...
        <ResponseField name="email" type="string | null" required>
          The business owner's email address, so a partner can follow up on a referral
          they made. Requires the `partner:email:read` scope; `null` without it, or
          while the account has no reachable address of its own.
        </ResponseField>
