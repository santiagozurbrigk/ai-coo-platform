...
source: "https://docs.whop.com/api-reference/beta/ledgers/ledger-activity"
...
| [Get Financial Report Breakdown](/api-reference/beta/ledgers/get-financial-report-breakdown) | <Badge color="blue" size="sm" stroke>GET</Badge> `/financial_reports/breakdown` |
