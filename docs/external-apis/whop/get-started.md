...
> Whop is on a mission to deliver everyone a sustainable income.
...
<CardGroup cols={3}>
  ...
  <Card title="Brick and Mortar" icon="store" href="/supported-business-models/brick-and-mortar">
    Accept in-store payments and manage orders for your physical location.
  </Card>
</CardGroup>
