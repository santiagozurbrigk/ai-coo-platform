...
<Steps>
  <Step title="Create your whop" titleSize="h3">
    ...
    * Complete the basic setup
    ...
    <img src="https://mintcdn.com/whop/gkU9N_oxv5Gb4qnv/images/createwhopcourse.png?fit=max&auto=format&n=gkU9N_oxv5Gb4qnv&q=85&s=d14fed36f8763747d43746fa87f87579" alt="Create course on Whop" width="1639" height="963" data-path="images/createwhopcourse.png" />
  </Step>
  ...
  <Step title="Add the Courses app" titleSize="h3">
    ...
    <img src="https://mintcdn.com/whop/XkQkLHsY-Hk8KVyG/how-to-videos/addingcoursestocoursewhop.gif?s=048906527c219c7686aad686735d70a6" alt="Add Courses app" width="1222" height="720" data-path="how-to-videos/addingcoursestocoursewhop.gif" />
  </Step>
  ...
  <Step title="Add the Content app" titleSize="h3">
    ...
    * Any introductions or first steps they should take
          ...
          <img src="https://mintcdn.com/whop/XkQkLHsY-Hk8KVyG/images/addingcontenttocourses.png?fit=max&auto=format&n=XkQkLHsY-Hk8KVyG&q=85&s=6f9018d0da1549c787e1166a54673846" alt="Add Content app" width="1833" height="964" data-path="images/addingcontenttocourses.png" />
  </Step>
  ...
  <Step title="Add the Forums app" titleSize="h3">
    ...
    * **Q\&A discussions**: Answer student questions and encourage peer-to-peer learning
    ...
    <img src="https://mintcdn.com/whop/XkQkLHsY-Hk8KVyG/images/addingforumsapptocourse.png?fit=max&auto=format&n=XkQkLHsY-Hk8KVyG&q=85&s=13750d1770c6c7a55957ea661cebe02b" alt="Add Forums app" width="1829" height="826" data-path="images/addingforumsapptocourse.png" />
  </Step>
  ...
  <Step title="Add the Chat app" titleSize="h3">
    ...
    * **Assignment submissions**: Create spaces for students to share their work and get feedback
    ...
    <img src="https://mintcdn.com/whop/XkQkLHsY-Hk8KVyG/images/addingchatapptocourse.png?fit=max&auto=format&n=XkQkLHsY-Hk8KVyG&q=85&s=19e0b4fcd54364559afd4e0687b6bb87" alt="Chat app added to a course" width="1830" height="964" data-path="images/addingchatapptocourse.png" />
  </Step>
  ...
  <Step title="Design your store page" titleSize="h3">
    ...
    * **Choose a clear name and headline**: Make it immediately obvious what students will learn and how it will benefit them. Examples: "Master Facebook Ads in 30 Days" or "Complete Python Programming Boot Camp"
    ...
    * **Add gallery images or video**: Viewers see this content at the top of your store page. Add a short video about you, your expertise, and what students will learn in the course
    * **Select the appropriate category**: This helps people discover your course when browsing Whop

          <img src="https://mintcdn.com/whop/gkU9N_oxv5Gb4qnv/images/storepagecourse.png?fit=max&auto=format&n=gkU9N_oxv5Gb4qnv&q=85&s=c7a985fb2a22bc3408294863c2f29803" alt="Course store page" width="1832" height="751" data-path="images/storepagecourse.png" />
  </Step>
  ...
  <Step title="Set up pricing" titleSize="h3">
    ...
    * **Subscription model**: For example, \$47/month for ongoing access with a continuing stream of new content
...
Now that you've set up the basic structure of your course business, learn how to use the **Courses** app in more detail.

### Understanding the course structure

Organize your course content with a three-level hierarchy:
...
* **Language settings**: Choose the language for closed captions on your videos.

## Next steps

<Card title="Grow your course business on Whop" icon="chart-line" href="/manage-your-business">
