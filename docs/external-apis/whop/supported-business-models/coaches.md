...
<Steps>
  ...
  <Step title="Create a product and fill your product page (add a custom CTA)" titleSize="h3">
    Go to your whop > select **Products** > **Add product**. Fill out your
    product page completely and choose a custom CTA (e.g., "Apply for coaching" or
...
<Card title="Grow your coaching business on Whop" icon="chart-line" href="/manage-your-business">
