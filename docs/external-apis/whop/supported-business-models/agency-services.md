...
**For clients:** Send private checkout links, collect payments, and give access to private project spaces where you can chat, share project materials, and manage timelines.
...
<Steps>
  <Step title="Create your whop" titleSize="h3">
    ...
    * Complete the basic setup
    ...
    <img src="https://mintcdn.com/whop/gkU9N_oxv5Gb4qnv/images/createwhopagencies.png?fit=max&auto=format&n=gkU9N_oxv5Gb4qnv&q=85&s=965a67dbb61d4b467779306c62dfad75" alt="New agency whop" width="1635" height="964" data-path="images/createwhopagencies.png" />
  </Step>

  <Step title="Add the Calendar Bookings app" titleSize="h3">
    Like Calendly, this app lets you configure a calendar where prospects can schedule discovery sales calls.

    1. Add the [**Calendar Bookings**](https://whop.com/apps/app_dC2dkRARmXE4qf/install/) app from the Whop App Store, then select **Configure Calendar Bookings** to set up your availability
    2. Select **Add availability** or **+** at the top right
    3. Add the: 
       * **Title** 
       * **Duration** 
    ...
    6. Select **Create**
           ...
           <img src="https://mintcdn.com/whop/XkQkLHsY-Hk8KVyG/how-to-videos/calendarbookingstoagency.gif?s=d3b0e54894bb55501e1c2b2ec1b626c7" alt="Add Calendar Bookings app" width="1222" height="720" data-path="how-to-videos/calendarbookingstoagency.gif" />
  </Step>
  ...
  <Step title="Add the Files app" titleSize="h3">
    ...
    * **Free resources:** Upload templates, audits, checklists, or anything you'd normally offer as a lead magnet
    ...
    Leads join your whop to access the resources. You capture their details, and they can browse your whop and book a call.

    <img src="https://mintcdn.com/whop/XkQkLHsY-Hk8KVyG/images/addfilestoagency.png?fit=max&auto=format&n=XkQkLHsY-Hk8KVyG&q=85&s=f7b77f7435c2281eb24e88752a2d3326" alt="Add Files app" width="1834" height="961" data-path="images/addfilestoagency.png" />
  </Step>
  ...
  <Step title="Add the Content app" titleSize="h3">
    ...
    * Your methodology or approach to solving client problems
          ...
          <img src="https://mintcdn.com/whop/XkQkLHsY-Hk8KVyG/images/addingcontenttoagencies.png?fit=max&auto=format&n=XkQkLHsY-Hk8KVyG&q=85&s=f0fc8aa509fde6c62106a93074166158" alt="Add Content app" width="1832" height="963" data-path="images/addingcontenttoagencies.png" />
  </Step>
  ...
  <Step title="Add the Chat app (optional)" titleSize="h3">
    ...
    * Connect with other prospects
    ...
    <Tip>
      Stay active in the chat to build relationships and demonstrate your expertise. Give prompt answers and share valuable insights. This positions you as helpful and knowledgeable before prospects even book a call.
    </Tip>

    <img src="https://mintcdn.com/whop/XkQkLHsY-Hk8KVyG/images/addingchattoagencies.png?fit=max&auto=format&n=XkQkLHsY-Hk8KVyG&q=85&s=bd588e32c4876b1aba849e8dbcd5333b" alt="Add Chat app" width="1832" height="963" data-path="images/addingchattoagencies.png" />
  </Step>
  ...
  <Step title="Set up a free pricing model" titleSize="h3">
    ...
    * Go to your whop > select **Products** > select **Add product**

    Configure the settings in the product to make it free to access.

    [Learn more about setting up pricing and products here](/manage-your-business/payment-processing/set-up-pricing).
  </Step>

  <Step title="Design your store page" titleSize="h3">
    Your store page is where prospects decide whether to join your agency's free whop. Select your whop name in the top left, then select **Design store page** to open the editor. Select **Edit details** to customize:
    ...
    * **Select "Agencies" as your category:** This helps people discover your services when browsing Whop
          ...
          <img src="https://mintcdn.com/whop/gkU9N_oxv5Gb4qnv/images/storepageagencies.png?fit=max&auto=format&n=gkU9N_oxv5Gb4qnv&q=85&s=884d10aae8d0a4e03bd011c981455d34" alt="Agency store page" width="1829" height="805" data-path="images/storepageagencies.png" />
  </Step>
  ...
  <Step title="Convert leads into paying clients" titleSize="h3">
    ...
    * [Choose your pricing](/manage-your-business/payment-processing/set-up-pricing) (one-time project fee or recurring retainer)
    ...
    * [Choose your pricing structure](/manage-your-business/payment-processing/set-up-pricing)
    * Add apps in your whop that are only accessible to this client:
      * **Chat**: Private 1:1 communication channel
      * **Files**: Upload project files, contracts, and assets
      ...
      * **Calendar**: Let clients book additional calls or check-ins
  ...
  <Step title="Manage your team" titleSize="h3">
    ...
    * [Learn more about managing your team, roles and permissions here](/manage-your-business/team-management/manage-team-roles)

    You can even pay your team through whop.

    * [Learn how to pay your team on Whop here](/manage-your-business/manage-payouts/pay-your-team)

    Add internal apps that only your team members can access to keep your operations organized.
    ...
    * **Calendar**: Let team members book 1-on-1s with you
  </Step>
</Steps>

## Next steps

<Card title="Grow your agency on Whop" icon="chart-line" href="/manage-your-business">
