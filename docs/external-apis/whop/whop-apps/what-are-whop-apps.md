...
* **Community-focused apps** – Chat, courses, live events, forums, and other social experiences that keep members engaged
* **Business-focused apps** – Market data feeds, SaaS tools, and utilities that open new revenue streams or streamline operations
...
<CardGroup cols={1}>
  <Card title="Start building your Whop app" icon="block-brick" href="/developer/api/quickstart">
