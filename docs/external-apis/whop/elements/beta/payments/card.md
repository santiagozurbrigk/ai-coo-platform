---
title: "CardElement"
source: "https://docs.whop.com/elements/beta/payments/card"
...
<div data-whop-split style={{ display: "flex", gap: "1.5rem", alignItems: "flex-start", flexWrap: "wrap" }}>
  ...
  <div style={{ flex: "1 1 20rem", minWidth: 0 }}>
    <div data-whop-demo-shell style={{ position: "relative", minHeight: "320px", transition: "min-height 200ms ease" }}>
      ...
      <div data-whop-demo-native="element:payments/card" data-whop-elements-version="1.0.0-beta.2" style={{ position: "relative" }} />
    </div>
...
Fires when card fields change. `complete` becomes true after the buyer fills all three. Use it to enable confirmation. `brand` is the detected card network. `funding` is the detected funding type (`credit`, `debit`, or `prepaid`), `null` until the number identifies one.
