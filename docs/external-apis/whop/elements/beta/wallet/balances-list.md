---
title: "ListElement"
source: "https://docs.whop.com/elements/beta/wallet/balances-list"
...
<div data-whop-platform="swift" style={{ display: "none" }}>
  ...
  * Pairs with [`BalanceElement`](/elements/beta/wallet/balances-balance#swift), which shows the same account's total and how it changed.
