---
title: "ReserveBreakdownElement"
source: "https://docs.whop.com/sdk/elements/reserve-breakdown-element"
...
**Callback signature:** (options: [`ReserveBreakdownElementOptions`](#reservebreakdownelementoptions)) => void
...
**Callback signature:** (snapshot: [`ReserveBreakdownElementSnapshot`](#reservebreakdownelementsnapshot)) => void
...
| Parameter | Type                                                                            | Description                                      |
| --------- | ------------------------------------------------------------------------------- | ------------------------------------------------ |
| `options` | `Partial`\<[`ReserveBreakdownElementOptions`](#reservebreakdownelementoptions)> | Partial options object with the values to update |
...
**Returns:** [`ReserveBreakdownElementSnapshot`](#reservebreakdownelementsnapshot)
