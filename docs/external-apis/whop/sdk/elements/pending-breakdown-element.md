---
title: "PendingBreakdownElement"
source: "https://docs.whop.com/sdk/elements/pending-breakdown-element"
...
**Callback signature:** (element: `PendingBreakdownElement`) => void

### `optionsUpdated`

Emitted when the element's options are updated via `updateOptions()`.

**Callback signature:** (options: [`PendingBreakdownElementOptions`](#pendingbreakdownelementoptions)) => void
...
**Callback signature:** (snapshot: [`PendingBreakdownElementSnapshot`](#pendingbreakdownelementsnapshot)) => void
...
| Parameter | Type                                                                            | Description                                      |
| --------- | ------------------------------------------------------------------------------- | ------------------------------------------------ |
| `options` | `Partial`\<[`PendingBreakdownElementOptions`](#pendingbreakdownelementoptions)> | Partial options object with the values to update |
...
**Returns:** [`PendingBreakdownElementSnapshot`](#pendingbreakdownelementsnapshot)
...
| --------- | ----------------------------------------------------------- | -------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `onReady` | `((element: PendingBreakdownElement) => void) \| undefined` | No       | -       | Callback fired when the element has finished loading and is ready for interaction. This is equivalent to listening to the 'ready' event.                 |
...
### PendingBreakdownElementSnapshot
