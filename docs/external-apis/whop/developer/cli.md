---
title: "CLI"
source: "https://docs.whop.com/developer/cli"
...
| `apps`                                | Fully hosted web apps on `*.whop.site`                      |
...
For a site visitors browse at `<route>.whop.site`, see [Websites](/developer/websites/overview).
