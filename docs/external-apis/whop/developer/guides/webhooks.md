...
| Payments                   | [`payment.authorized`](/api-reference/payments/payment-authorized), [`payment.canceled`](/api-reference/payments/payment-canceled), [`payment.created`](/api-reference/payments/payment-created), [`payment.failed`](/api-reference/payments/payment-failed), [`payment.pending`](/api-reference/payments/payment-pending), [`payment.succeeded`](/api-reference/payments/payment-succeeded)                                                                                                                                                                                   |
