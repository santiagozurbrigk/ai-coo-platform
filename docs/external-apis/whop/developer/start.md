...
source: "https://docs.whop.com/developer/start"
...
Pick what you're building. Each path starts with a working guide and links its reference.
...
If you're not sure yet, take the [quickstart](/developer/api/quickstart), then [test in the sandbox](/developer/guides/sandbox) before going live. API keys live in the [developer dashboard](https://whop.com/dashboard/developer).
