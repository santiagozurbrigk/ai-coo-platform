---
title: "Fees"
source: "https://docs.whop.com/payments-and-billing/fees/fees"
...
<CardGroup cols={3}>
  ...
  <Card title="Payment optimizations" icon="chart-line">
    Real-time retries and automatically updated cards to boost revenue.
  </Card>
  ...
  <Card title="24×7 support" icon="headset">
    Live chat and email assistance any hour of the day, any day of the week.
  </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
        ...
        <div className="text-sm ">
          ...
          <div className="text-gray-700 dark:text-gray-300">
            ...
            <span className="text-gray-500">+ 1% when the transaction requires </span><span className="text-[#6366f1]">currency conversion</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="-mx-6 border-t mb-6 border-gray-200 dark:border-gray-800">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
        ...
        <div className="text-sm ">
          ...
          <div className="text-gray-700 dark:text-gray-300">
            per successful transaction through financing partners<br /><br />
          </div>
        </div>
      </div>
    </div>
...
Compare what other platforms charge. The listed pricing applies to new merchants that sign up today. Enterprise customers can [book a call with the Whop sales team](https://calendly.com/d/cv3h-5mq-vc2/whop-payments-enterprise-call).
