---
title: "Create a new chat widget"
source: "https://marketplace.gohighlevel.com/docs/ghl/chat-widget/create-chat-widget"
seccion: "Chat Widget > Chat Widget > Create a new chat widget"
api_version: "v3"
...
- **version** `number` _required_ — Version
- **chatType** `string` _required_ — Chat Type. The public API supports only liveChat and emailChat; any other value is rejected with a 422.
  - Available options: `liveChat`, `emailChat`
