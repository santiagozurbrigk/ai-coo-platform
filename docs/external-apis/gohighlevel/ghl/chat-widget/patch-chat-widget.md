---
title: "Patch Chat Widget"
source: "https://marketplace.gohighlevel.com/docs/ghl/chat-widget/patch-chat-widget"
seccion: "Chat Widget > Chat Widget > Patch Chat Widget"
api_version: "v3"
...
- **chatType** `string` — Chat Type. The public API supports only liveChat and emailChat; any other value is rejected with a 422.
