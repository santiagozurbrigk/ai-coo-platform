...
source: "https://marketplace.gohighlevel.com/docs/ghl/ad-publishing/li-upsert-campaign-group"
seccion: "Ad Manager > LinkedIn Ads > Upsert ad campaign group"
api_version: "v3"
...
- **budget** `object` — Campaign group budget
- **adCampaigns** `object[]` — Child ad campaigns
