...
seccion: "Invoice > Text2Pay > Create & Send"
api_version: "v3"
...
- **includeTermsNote** `boolean` — include terms & notes with receipts
- **action** `string` _required_ — create invoice in draft mode or send mode
  - Available options: `draft`, `send`
- **userId** `string` _required_ — id of user generating invoice
- **discount** `object`
...
- **invoiceUrl** `string` _required_ — preview url of generated invoice
