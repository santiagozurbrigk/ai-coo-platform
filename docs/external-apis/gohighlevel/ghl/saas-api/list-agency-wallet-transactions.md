---
title: "List agency wallet transactions"
source: "https://marketplace.gohighlevel.com/docs/ghl/saas-api/list-agency-wallet-transactions"
seccion: "SaaS > SaaS > List agency wallet transactions"
api_version: "v3"
capturado: "2026-08-30"
metodo: "POST"
path: "/saas/companies/:companyId/wallet-transactions"
---

# List agency wallet transactions

```http
POST /saas/companies/:companyId/wallet-transactions
```
...
- **companyId** `string` _required_ — Company ID to list transactions for
