...
seccion: "Payments > Custom Provider > Create new integration"
api_version: "v3"
...
- **supportsSubscriptionSchedule** `boolean` _required_ — Whether the config supports subscription schedule or not. true represents config supports subscription schedule
