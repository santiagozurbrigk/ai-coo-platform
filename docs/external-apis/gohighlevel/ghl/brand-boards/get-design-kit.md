---
title: "Get Design Kit"
source: "https://marketplace.gohighlevel.com/docs/ghl/brand-boards/get-design-kit"
seccion: "Brand Boards > Design Kits > Get Design Kit"
api_version: "v3"
...
- **designKitId** `string` _required_ — ID of the design kit to retrieve.
