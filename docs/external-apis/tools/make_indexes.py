...
def whop():
    ...
    lines = [
        ...
        "| Archivo | Qué es |", "| --- | --- |",
        "| [`RESUMEN-LIMITLESS.md`](./RESUMEN-LIMITLESS.md) | **Empezar por acá** — lo que Limitless necesita de Whop, con las preguntas de `apis-sin-documentacion.md` respondidas |",
