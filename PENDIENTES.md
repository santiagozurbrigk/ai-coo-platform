...
| 2026-08-24 | feat(metrics): auto-mapeo Excel → OTC + snapshot source — otc-metric-registry.ts (22 métricas con aliases), MetricSource acepta `snapshot:{key}`, auto-crea custom_metrics cards, badges de reconocimiento en dialog | `claude/architecture-review-improvements-fdj4ae` |
