...
**El PR #31 llegó en el medio y movió el piso.** Mientras esto se construía se mergearon a la rama el módulo de Embudos (#30) y la **notch nav como navegación definitiva** (#31), que **eliminó `app-topbar.tsx`** y todo el sidebar clásico. El panel se había montado en los dos shells justamente porque la notch nav podía activarse en cualquier momento; con el sidebar borrado, esa mitad del trabajo quedó sin objeto y el panel vive ahora sólo en la isla derecha de la notch nav. Se aceptó el borrado del topbar en el merge y se actualizaron los comentarios que hablaban de "la topbar clásica", que ya no existe.
